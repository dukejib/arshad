...
<div class="container block-transparent mt-2 mb-2">
    ...
    <div class="row">
        ...
        <div class="headings animated fadeInLeft">
            Privacy Policy
            <p>
                Customer privacy is one of our priority.We take strict measures to assure your data is kept safe
            </p>
        </div>
...
<div class="container block-white">
    ...
    <div class="container">
        ...
        <div class="row mt-2 privacy">
            <div class="subheading">Privacy Policy</div>
        ...
        <div class="row mt-2 privacy">
            <div class="subheading">Change/Remove Your Personal Information</div>
            <p class="justify-left">
        ...
        <div class="row mt-2 privacy">
            <div class="subheading">Information Usage</div>
            <p class="justify-left">
        ...
        <div class="row mt-2 privacy">
            <div class="subheading">Socail Sharing / Links </div>
            <p class="justify-left">
                    Ribsncuts.com links to other social websites that may collect personally identifiable information about you. Ribsncuts is not responsible for the content of those linked websites.
